...
const navItems = [
    { to: '/dashboard', icon: UserCircleIcon, label: 'Profil' },
    { to: '/jobs', icon: BriefcaseIcon, label: 'Lowongan' },
    { to: '/history', icon: ClockIcon, label: 'Riwayat' },
];
...
const CandidateSidebar: React.FC = () => {
    ...
    const sidebarContent = (
        <div className="flex flex-col h-full">
             <div className={`flex items-center h-16 px-4 shrink-0 ${isSidebarCollapsed ? 'justify-center' : 'justify-end'}`}>
                <button
                    onClick={toggleSidebarCollapse}
                    className="p-2 hidden md:block text-gray-500 rounded-lg hover:bg-gray-100"
