...
const LoginPage: React.FC = () => {
  ...
  //   // optional validasi candidate
  //   if (!email.endsWith('@gmail.com') && email !== 'hrd@test.com') {
  ...
  //   if (success) {
  //     navigate(
  //       email === 'hrd@test.com' ? '/hrd/dashboard' : '/dashboard',
  //       { replace: true }
  //     );
  //   }
  // };
...
//     const isHrdAttempt = email === 'hrd@test.com';
//     let success = false;
...
//     if (success) {
//       navigate(
//         isHrdAttempt ? '/hrd/dashboard' : '/dashboard',
//         { replace: true }
//       );
//     }
//   };
